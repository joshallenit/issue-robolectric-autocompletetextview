...
@Config(
    shadows = [ShadowInsertionHandleView::class],
    instrumentedPackages = [
        // Work around for https://github.com/robolectric/robolectric/issues/6593#issuecomment-876844270
...
class AutoCompleteTextViewTest {
    ...
    fun autoCompleteList_whenItemClicked_setsText() {
        ...
        onView(ViewMatchers.withTagValue(Matchers.equalTo(VIEW_TAG)))
            .perform(typeText("Bel"))
            .perform(click()) // This is necessary in Robolectric to display PopupWindow$PopupViewContainer
